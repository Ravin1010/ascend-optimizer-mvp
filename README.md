...
- `data/live_strategy_snapshots.csv` — generated by the collector CLI; not created until collection is run.
...
The default output is `data/live_strategy_snapshots.csv`.
